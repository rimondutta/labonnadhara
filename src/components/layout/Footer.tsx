        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16 md:mb-24">
          ...
          <div className="lg:col-span-4 xl:col-span-5 flex flex-col gap-6">
            ...
            <div className="flex gap-3 mt-2">
              <a aria-label="Facebook" href="https://www.facebook.com/labonnadhara" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-[#D62B72] hover:bg-[#D62B72] hover:text-white transition-colors shadow-sm">
              ...
              <a aria-label="Instagram" href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-[#D62B72] hover:bg-[#D62B72] hover:text-white transition-colors shadow-sm">
              ...
              <a aria-label="WhatsApp" href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-[#D62B72] hover:bg-[#D62B72] hover:text-white transition-colors shadow-sm">
