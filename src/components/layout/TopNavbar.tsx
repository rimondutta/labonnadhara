      ...
      >
        ...
        <div className="bg-[#D62B72] text-white text-[11px] sm:text-[12px] font-semibold tracking-wide px-4 md:px-7 py-2 flex flex-row items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 md:gap-2.5 shrink-0">
            ...
            <a href="https://www.facebook.com/labonnadhara" target="_blank" rel="noopener noreferrer" className="text-white/90 hover:text-white transition-colors" aria-label="Facebook">
            ...
            <a href="https://wa.me/8801863230150" target="_blank" rel="noopener noreferrer" className="text-white/90 hover:text-white transition-colors" aria-label="WhatsApp">
