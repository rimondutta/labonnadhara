        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 xl:gap-20">
          ...
          <div className="w-full lg:w-[42%] flex flex-col pt-2">
            ...
            <a
              ...
              className="w-full py-3.5 rounded-full font-sans font-bold text-[15px] text-white flex items-center justify-center gap-2 transition-all duration-200 hover:opacity-90 hover:shadow-lg hover:-translate-y-0.5 mb-6"
