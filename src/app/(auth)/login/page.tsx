    ...
    <div className="w-full max-w-sm">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg py-2.5 px-4 text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-6"
        >
          {googleLoading ? (
